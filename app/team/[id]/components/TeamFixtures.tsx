...
export default function Fixtures({ fixturesByTeamId, teamId }: PageProps) {
  ...
  console.log("fixesfuture", fixturesFuture);
  ...
  const firstItemsFixturesDone = reversedFixturesDoneData.slice(
    0,
    visibleItemsCount
  );
      ...
      <div className="flex flex-col w-full justify-center items-center">
        <div
          className="flex w-full justify-center items-center p-2 bg-gradient-to-r
                from-gray-800/80 to-gray-800/30"
        >
          Upcoming Matches
        </div>
            ...
            {firstItemsFixturesFuture.map((fixture, i) => (
              <Link
                ...
                className="w-full flex-shrink-0 flex text-neutral-100 items-center h-36
                                    bg-gradient-to-r from-black/90 to-black/40 hover:bg-gray-600"
              >
        ...
        {firstItemsFixturesDone.map((fixture, i) => (
          <div
            ...
            className="flex w-full text-neutral-100 items-center h-36
                        bg-gradient-to-r from-black/90 to-black/40 hover:bg-gray-400"
          >
            <Link
              href={`/match/${fixture.fixture.id}`}
              key={fixture.fixture.id}
